  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <Button className="hidden sm:inline-flex" onClick={() => { setTab('raw'); setOpen(true); }}>Add Inventory Item</Button>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="space-y-3">
            ...
            {filtered.length === 0 && (
              <div className="text-sm text-gray-500 text-center py-6 border rounded-lg">No raw materials added yet.</div>
            )}
          </div>
        </CardContent>
      </Card>
      ...
      <div className="sticky-action-bar sm:hidden">
        <Button className="w-full" onClick={() => { setTab('raw'); setOpen(true); }}>Add Inventory Item</Button>
      </div>
